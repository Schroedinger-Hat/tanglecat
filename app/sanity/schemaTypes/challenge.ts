...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "text",
      description:
        "The instructions for the challenge, displayed in the challenge detail page. If not provided, we will use the default instructions.",
    }),
    defineField({
      name: "points",
      title: "Points",
    ...
    defineField({
      ...
      type: "number",
      description:
        "(not enabled) The minimum number of points a player need to have to unlock the challenge",
      validation: (Rule) => Rule.min(0),
    }),
    defineField({
      name: "startDate",
    ...
    defineField({
      ...
      initialValue: false,
      description:
        "If true, the challenge will be validated via a webhook / integration e.g. github stars, google form",
    }),
    defineField({
      name: "callToAction",
