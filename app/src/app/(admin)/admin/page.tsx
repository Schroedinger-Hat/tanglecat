    ...
    <div className="py-8">
      <div className="max-w-4xl mx-auto px-2">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage your assigned challenges below</p>
        </div>
        {supervisor?.assignedChallenges?.length > 0 && (
          <SupervisorChallenges challenges={supervisor.assignedChallenges} type="challenge" />
        )}
        {supervisor?.assignedAwards?.length > 0 && (
          <SupervisorChallenges awards={supervisor.assignedAwards} type="award" />
        )}
      </div>
    </div>
  )
